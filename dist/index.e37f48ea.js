...
var _newRecipeViewJs = require("./views/newRecipeView.js");
var _newRecipeViewJsDefault = parcelHelpers.interopDefault(_newRecipeViewJs);
...
const controlSearchResult = async function() {
    try {
        (0, _resultViewJsDefault.default).spinner();
        // 1) get search query .
        const query = (0, _searchViewJsDefault.default).getQery();
        if (!query) return;
        // 2) load search results
        await _modelJs.searchResult(query);
        ...
        (0, _resultViewJsDefault.default).render(_modelJs.getResultPage(1));
        (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
    } catch (error) {}
};
const controlPagination = function(goToPage) {
    // 3) render the NEW results & page button ATST .
    (0, _resultViewJsDefault.default).render(_modelJs.getResultPage(goToPage));
    (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
};
...
const controlNewRecipe = async function(newRecipe) {
    try {
        ...
        (0, _newRecipeViewJsDefault.default).renderError(error.message);
    }
};
const init = function() {
    (0, _bookmarkViewJsDefault.default).addHandlerRender(controlLoadBookmarks);
...
var classofRaw = require("ba69fe25dedfd475");
var uncurryThisRaw = require("c364b4b0bcd437b");
...
},{"ba69fe25dedfd475":"bdfmm","c364b4b0bcd437b":"bAiTz"}],"bdfmm":[function(require,module,exports) {
var uncurryThisRaw = require("c271dc0537f0fae3");
...
},{"c271dc0537f0fae3":"bAiTz"}],"bAiTz":[function(require,module,exports) {
var NATIVE_BIND = require("67797a48b4dd184b");
...
},{"67797a48b4dd184b":"i16Dq"}],"fOR0B":[function(require,module,exports) {
...
},{"ecc4d354cb42bea8":"bjFlO","b37df495bcdc1d99":"hL6D2"}],"bjFlO":[function(require,module,exports) {
...
},{"13360f2842eba261":"hL6D2","103e488c0928755a":"l3Kyn","cbf9b0e0779cc368":"gC2Q5","3f2eb7efeae2f72b":"92ZIi","548b10f284264c72":"l6Kgd","358f00f3103bd55b":"9jh7O","9b2ce14119fd2412":"7AMlF"}],"l6Kgd":[function(require,module,exports) {
...
},{"239b95ec6c7aa699":"7GlkT","547ee4f9dab0cc76":"gOMir","5acd31cba656d393":"i16Dq"}],"2pze4":[function(require,module,exports) {
...
var setImmediate = require("4219ce460223bd08").set;
// `setImmediate` method
...
},{"33581c362196ed1f":"dIGt4","9a84e40db4964af6":"i8HOC","4219ce460223bd08":"7jDg7"}],"dXNgZ":[function(require,module,exports) {
/**
...
const state = {
    ...
    search: {
        ...
        result: [],
        page: 1,
        reusltPerPage: (0, _config.RESULT_PER_PAGE)
    },
    bookmarks: []
};
const loadRecipe = async function(hashId) {
    try {
        const data = await (0, _helpers.getJSON)(`${(0, _config.API_URL)}${hashId}`);
        ...
        if (state.bookmarks.some((bm)=>bm.id === hashId)) state.recipe.bookmarked = true;
...
const uploadRecipe = async function(newRecipe) {
    ...
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "").map((ingr)=>{
            ...
            if (ingrArray.length !== 3) throw new Error("Wrong ingredients format. please use the correct format ♥");
        ...
        const data = await (0, _helpers.sendJSON)(`${(0, _config.API_URL)}?key=${(0, _config.KEY)}`, recipeObj);
        console.log(data);
        location.reload();
    } catch (error) {
        throw error;
...
// variables that should be constants and 
...
const KEY = "fb0d2d00-6568-409b-b572-0170cb74c5d4";
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    <div class="recipe__ingredients">
      ...
      ${this._data.ingredients.map((ingred)=>{
            return `
        <li class="recipe__ingredient">
          <svg class="recipe__icon">
            <use href="${0, _iconsSvgDefault.default}.svg#icon-check"></use>
          </svg>
          <div class="recipe__quantity">${ingred.quantity ? (0, _fractyDefault.default)(ingred.quantity).toString() : ""}</div>
...
},{"url:../../img/icons.svg":"loVOp","fracty":"hJO4d","./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    */ const btn = event.target.closest(".btn--inline");
    ...
    _generateMarkup() {
        ...
        const howManyPages = Math.ceil(this._data.result.length / this._data.reusltPerPage);
        const currentPage = this._data.page;
        // we're in Page 1, and there are other pages .
        if (currentPage === 1 && howManyPages > 1) return `
      <button data-goto="${currentPage + 1}" class="btn--inline pagination__btn--next">
        ...
        // we're in last page .
        if (currentPage === howManyPages && howManyPages > 1) return `
        ...
        if (currentPage < howManyPages) return `
        <button data-goto="${currentPage - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
              <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
            </svg>
...
},{"./view":"bWlJ9","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ck58R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class NewRecipeView extends (0, _viewDefault.default) {
    ...
    _addHandlerUploadNewRecipe(handler) {
      ...
      const data = Object.fromEntries(dataArray); */ const data = Object.fromEntries(new FormData(this));
            handler(data);
        });
    }
    _generateMarkup() {}
}
exports.default = new NewRecipeView();
